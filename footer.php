...
<!-- Andrea bygger -->
 ...
 <div class ="footer-general-information">
    <div class="footer-general-text">Sortiment</div>
    <div class="footer-general-text">Om Oss</div>
    <div class="footer-general-text">Kontakt</div>
    <div class="footer-general-text">Q&A</div>
    <div class="footer-general-text">Support</div>
 </div>
